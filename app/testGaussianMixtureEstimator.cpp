...
void findMinMax(const cuars::VectorVector2& points, cuars::Vector2& pmin, cuars::Vector2& pmax);

void rangeToPoint(double* ranges, int num, double angleMin, double angleRes, double rangeMax, cuars::VectorVector2& points);

void plotEllipse(std::ostream& out, int idx, const cuars::Vector2& mean, const cuars::Matrix2& covar);

void plotEllipses(std::ostream& out, const cuars::VectorVector2& means, const cuars::VectorMatrix2& covars);
