...
namespace cuars {
    ...
    public:
        ...
        /**
         * Returns the iterator pointing to the ending position of the octree vector.
         * (Ending position is after the last item).
         * @return 
         */
        Iterator end() {
            return items_.end();
         ...
         * @param low the lower corner cell of the octree cell containing [first, last[
         * @param mid the splitting cell (iterator points to the item NOT LESS than this one)
         * @param upp the upper corner cell of the octree cell containing [first, last[
         * @return 
         */
        ConstIterator findSplit(ConstIterator first, ConstIterator last, PointInt& low, PointInt& mid, PointInt& upp) const {
            Item itemMid;
            if (last != first) {
                --last;
            }
        ...
        ConstIterator findSplit(const PointScalar& q0, const PointScalar& q1) const {
